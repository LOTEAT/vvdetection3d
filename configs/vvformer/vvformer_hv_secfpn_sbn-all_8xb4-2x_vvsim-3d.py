_base_ = [
    '../_base_/models/vvformer_hv_fpn_vvsim.py',
    '../_base_/datasets/vvsim_lidar_camera-3d-2class.py', '../_base_/schedules/schedule-2x.py',
...
model = dict(
    ...
    bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            ranges=[
                [-50, -50, -1.50032795, 50, 50, -1.80032795],
                [-50, -50, -1.74440365, 50, 50, -1.74440365],
                [-50, -50, -1.68526504, 50, 50, -1.68526504],
                [-50, -50, -1.67339111, 50, 50, -1.67339111],
