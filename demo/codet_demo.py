...
from vvdet3d.apis import CoDet3DInferencer


def parse_args():
    parser = ArgumentParser()
    parser.add_argument('dataloader', help='Data sample index or config file')
    parser.add_argument('sample_idx', type=int, help='Index of data sample')
    ...
    init_kws = ['model', 'weights', 'device', 'sample_idx', 'dataloader']
    init_args = {}
    for init_kw in init_kws:
        init_args[init_kw] = call_args.pop(init_kw)
    init_args['out_dir'] = call_args['out_dir']
...
def main():
    ...
    inferencer = CoDet3DInferencer(**init_args)
    call_args['inputs'] = inferencer.prepare_data()
