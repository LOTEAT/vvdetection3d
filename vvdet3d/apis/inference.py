...
from vvdet3d.registry import DATASETS, MODELS
from vvdet3d.structures import Box3DMode, Det3DDataSample, get_box_type
...
def init_model(config: Union[str, Path, Config],
    ...
    init_default_scope(config.get('default_scope', 'vvdet3d'))
