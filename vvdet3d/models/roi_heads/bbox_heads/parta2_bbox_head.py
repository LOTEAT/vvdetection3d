...
from vvdet3d.models import make_sparse_convmodule
from vvdet3d.models.layers.spconv import IS_SPCONV2_AVAILABLE
from vvdet3d.utils.typing_utils import InstanceList
...
from vvdet3d.models.layers import nms_bev, nms_normal_bev
from vvdet3d.registry import MODELS, TASK_UTILS
from vvdet3d.structures.bbox_3d import (LiDARInstance3DBoxes,
                                        rotation_3d_in_axis, xywhr2xyxyr)
from vvdet3d.utils.typing_utils import SamplingResultList
...
class PartA2BboxHead(BaseModule):
    ...
    def multi_class_nms(self,
        ...
        Note:
            ...
            implemented in `vvdet3d.core.post_processing`. We are considering
