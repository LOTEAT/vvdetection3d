...
from vvdet3d.registry import VISUALIZERS
from vvdet3d.structures import (BaseInstance3DBoxes, Box3DMode,
...
class Det3DLocalVisualizer(DetLocalVisualizer):
    ...
    Examples:
        ...
        >>> import torch
        >>> from mmengine.structures import InstanceData
        >>> from vvdet3d.structures import (DepthInstance3DBoxes
        ...                                 Det3DDataSample)
        >>> from vvdet3d.visualization import Det3DLocalVisualizer
        ...
        >>> from vvdet3d.structures import PointData
        >>> det3d_local_visualizer = Det3DLocalVisualizer()
        >>> points = np.random.rand(1000, 3)
        ...
        if draw_gt and data_sample is not None:
            if 'gt_instances_3d' in data_sample:
                gt_data_3d = self._draw_instances_3d(
                    ...
                    data_sample.metainfo, vis_task, show_pcd_rgb, (0,230, 0))
