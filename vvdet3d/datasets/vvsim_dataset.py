...
from vvdet3d.structures import LiDARInstance3DBoxes
from vvdet3d.structures.bbox_3d.cam_box3d import CameraInstance3DBoxes
from .codet3d_dataset import CoDet3DDataset


@DATASETS.register_module()
class VVSimDataset(CoDet3DDataset):
    r"""NuScenes Dataset.
    ...
    def parse_ann_info(self, info: dict) -> dict:
        ...
        if ann_info is not None:
            ...
            if self.with_velocity:
                ...
                gt_velocities = ann_info['gt_bboxes_3d'][:, 7:]
                nan_mask = np.isnan(gt_velocities[:, 0])
                gt_velocities[nan_mask] = [0.0, 0.0]
                gt_bboxes_3d[:, 7:] = gt_velocities
