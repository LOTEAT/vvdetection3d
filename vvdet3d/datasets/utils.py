...
# yapf: disable
from vvdet3d.datasets.transforms import (LoadAnnotations3D,
...
def concat_rotation_translation(
        rotation: list, translation: list) -> list:
    """Concatenate rotation and translation into a 4x4 matrix."""
    result = np.eye(4, dtype=np.float32)
    result[:3, :3] = np.array(rotation, dtype=np.float32)
    result[:3, 3] = np.array(translation, dtype=np.float32)
