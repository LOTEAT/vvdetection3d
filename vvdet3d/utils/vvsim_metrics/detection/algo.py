...
def accumulate(gt_boxes: EvalBoxes,
    ...
    if verbose:
        print("Found {} GT of class {} out of {} total across {} samples.".
              format(npos, class_name, len(gt_boxes.all), len(gt_boxes.sample_idxes)))
    ...
    if verbose:
        print("Found {} PRED of class {} out of {} total across {} samples.".
              format(len(pred_confs), class_name, len(pred_boxes.all), len(pred_boxes.sample_idxes)))
    ...
    for ind in sortind:
        ...
        for gt_idx, gt_box in enumerate(gt_boxes[pred_box.sample_idx]):

            # Find closest match among ground truth boxes
            if gt_box.detection_name == class_name and not (pred_box.sample_idx, gt_idx) in taken:
        ...
        if is_match:
            taken.add((pred_box.sample_idx, match_gt_idx))
            ...
            gt_box_match = gt_boxes[pred_box.sample_idx][match_gt_idx]
