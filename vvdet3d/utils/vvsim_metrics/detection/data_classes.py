...
class DetectionBox(EvalBox):
    ...
    def __init__(self,
        ...
        super().__init__(sample_idx, translation, size, rotation, velocity, ego_translation, num_pts)
    ...
    def __eq__(self, other):
        return (self.sample_idx == other.sample_idx and
    ...
    def deserialize(cls, content: dict):
        """ Initialize from serialized content. """
        return cls(sample_idx=content['sample_idx'],
